...
a board from the **real world within ~100m** — the actual roads, canals, buildings, and
...
3. The app geocodes the address and pulls the real world within ~100m: the trees (from the
...
- **Spatial query:** the board needs "trees within ~100m of an address" → **PostGIS**
