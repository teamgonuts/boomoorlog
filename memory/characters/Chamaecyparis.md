...
- **Phytophthora lateralis root pathogen** — soil oomycete, not an animal, but the dominant biotic threat — included for completeness. [Wikipedia: Chamaecyparis lawsoniana](https://en.wikipedia.org/wiki/Chamaecyparis_lawsoniana)
- **Goldcrest (Regulus regulus)** — 1–2 pairs per mature tree; conifer-obligate, builds hammock-nests slung beneath dense needled branches. [RSPB: Goldcrest](https://www.rspb.org.uk/birds-and-wildlife/goldcrest)
- **Firecrest (Regulus ignicapilla)** — 0–1 pairs per mature tree; less conifer-specialised but readily uses Lawson cypress. [Birdfact: Goldcrest vs Firecrest](https://www.birdfact.com/articles/goldcrest-or-firecrest)
- **Coal Tit (Periparus ater)** — 1–2 pairs per mature tree; conifer-preferring tit, gleans aphids and small invertebrates from needles. [Plantura: Coal tit](https://plantura.garden/uk/garden-birds/guides/coal-tit)
- **Finches and small passerines (Fringilla coelebs, Carduelis spp., Sylvia spp.)** — several pairs per mature tree; "dense foliage provides shelter for nesting birds, including various finches, when many broadleaved trees are still in bud." [Woodland Trust: Lawson cypress](https://www.woodlandtrust.org.uk/trees-woods-and-wildlife/british-trees/a-z-of-british-trees/lawson-cypress/)
- **Wood Pigeon and Collared Dove (Columba palumbus, Streptopelia decaocto)** — 1–3 pairs per mature tree; the dense crown is preferred urban nesting habitat. [Backyard Gardener: Bird Nest Cypress](https://www.backyardgardener.com/plantname/chamaecyparis-lawsoniana-bird-nest-cypress/)
- **Squirrels (Sciurus spp.)** — 1 working a cone-bearing tree; cones provide seed and the dense crown gives nesting cover (drey sites). [Backyard Gardener: Bird Nest Cypress](https://www.backyardgardener.com/plantname/chamaecyparis-lawsoniana-bird-nest-cypress/)
