...
def char_page(c, st, rel_photo, rel_sprite):
    ...
    out.append(f'<div class="ib-sprite"><img src="{rel_sprite}" alt="{esc(c["genus"])} sprite"></div>')
...
.ib-sprite{display:flex;justify-content:center;align-items:flex-end;height:200px;
  background:radial-gradient(ellipse at 50% 90%,rgba(255,255,255,.06),transparent 70%)}
.ib-sprite img{image-rendering:pixelated;max-height:200px;width:auto}
